...
function Search ({setImageData}) {
  ...
  return (
    <div className="flex justify-center mt-24">
      <input onChange={inputUpdate} className="sm:w-1/2 w-3/4  px-7 h-14 border border-blue-400 rounded-tl-3xl rounded-bl-3xl mb-12" type="search" name="search" placeholder="Search image" />
